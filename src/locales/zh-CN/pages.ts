export default {
  ...
  'pages.photo-logs': '照片日志',
  'pages.photo-logs.title': '照片日志列表',
  'pages.photo-logs.create': '新建照片日志',
  'pages.photo-logs.edit': '编辑照片日志',
  'pages.photo-logs.delete': '删除照片日志',
  'pages.photo-logs.view': '查看照片日志',
  'pages.logs': '日志管理',
