export default {
  ...
  'pages.logs': '日志管理',
  'pages.logs.photo-logs': '照片日志',
  'pages.logs.photo-logs.title': '照片日志列表',
  'pages.logs.photo-logs.create': '新建照片日志',
  'pages.logs.photo-logs.edit': '编辑照片日志',
  'pages.logs.photo-logs.delete': '删除照片日志',
  'pages.logs.photo-logs.view': '查看照片日志',
};
